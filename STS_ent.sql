...
insert into total_ent values(tseq.NEXTVAL,'1','BRUNO MAJOR 내한 공연','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','BRUNO MAJOR','BRUNO MAJOR_D');
insert into total_ent values(tseq.NEXTVAL,'1','MY AUNT MARY 단독 공연','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','MY AUNT MARY','MY AUNT MARY_D');
insert into total_ent values(tseq.NEXTVAL,'1','UFO STATION 페스티벌','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','UFO STATION','UFO STATION_D');
insert into total_ent values(tseq.NEXTVAL,'1','나캠든 팬미팅','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','나캠든개론','나캠든개론_D');
insert into total_ent values(tseq.NEXTVAL,'1','SMILE LOVE WEEKEND','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','스마일러브위크엔드','스마일러브위크엔드_D');
insert into total_ent values(tseq.NEXTVAL,'1','GEORGE 단독 콘서트','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','죠지 단독','죠지 단독_D');
insert into total_ent values(tseq.NEXTVAL,'1','차학연 팬미팅','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','차학연','차학연_D');
insert into total_ent values(tseq.NEXTVAL,'1','코다라인 내한 공연','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'s20a30b40','코다라인','코다라인_D');
--연극 데이터
insert into total_ent values(tseq.NEXTVAL,'2','망원동 브라더스','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로8세로10','망원동 브라더스','망원동 브라더스_D');
insert into total_ent values(tseq.NEXTVAL,'2','비누향기','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로8세로7','비누향기','비누향기_D');
insert into total_ent values(tseq.NEXTVAL,'2','세일즈맨의 죽음','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로10세로7','세일즈맨의 죽음','세일즈맨의 죽음_D');
insert into total_ent values(tseq.NEXTVAL,'2','수상한 흥신소','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로16세로10','수상한 흥신소','수상한 흥신소_D');
insert into total_ent values(tseq.NEXTVAL,'2','연극 라면','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로8세로9','연극 라면','연극 라면_D');
insert into total_ent values(tseq.NEXTVAL,'2','오백에 삼십','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로7세로6','오백에 삼십','오백에 삼십_D');
insert into total_ent values(tseq.NEXTVAL,'2','옥탑방 고양이','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로8세로8','옥탑방 고양이','옥탑방 고양이_D');
insert into total_ent values(tseq.NEXTVAL,'2','최초의 웃음','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로9세로10','최초의 웃음','최초의 웃음_D');
insert into total_ent values(tseq.NEXTVAL,'2','행오버','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로7세로6','행오버','행오버_D');
insert into total_ent values(tseq.NEXTVAL,'2','행오버','우리집','19:00',to_date('2023-11-11','yyyy-mm-dd'),to_date('2023-11-13','yyyy-mm-dd'),8000,'가로10세로8','행오버','행오버_D');
